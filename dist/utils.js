...
exports.enableAutoMerge = exports.getChangelogEntry = exports.getReleaseNotes = exports.getReleaseTitle = exports.getDate = exports.getReleaseCommitTitle = exports.getCommitParts = exports.getSections = exports.verifyPullRequest = exports.getMergeData = exports.getCommitBody = void 0;
/**
...
function getMergeData(prData) {
    ...
    return {
        title: (headRefName === null || headRefName === void 0 ? void 0 : headRefName.startsWith('merge/')) ? title : `${title} (#${number})`,
        message: getCommitBody(getSections(body || '')),
        strategy: (headRefName === null || headRefName === void 0 ? void 0 : headRefName.startsWith('merge/')) ? 'merge' : 'squash',
    };
}
...
function enableAutoMerge(prData) {
    return 'merge';
}
