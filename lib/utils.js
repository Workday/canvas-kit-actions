...
function getMergeData(prData) {
    ...
    return {
        commitHeadline: (headRefName === null || headRefName === void 0 ? void 0 : headRefName.startsWith('merge/'))
            ? title
            : `${sections['breaking changes'] ? title === null || title === void 0 ? void 0 : title.replace(': ', '!: ') : title} (#${number})`,
